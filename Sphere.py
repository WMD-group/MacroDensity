...
for radius in range(1,20):
    print "Radius is:", radius*0.5
    sph_tot, sph_av, sph_max = pot.sphere_potential(grid_pot,resolution_x,resolution_y,resolution_z,NGX,NGY,NGZ,[0.5,0.5,0.5],radius*0.5)
    print "------------------------------------------"
    print "Total charge in sphere : ", sph_tot
    print "Avrge charge in sphere : ", sph_av
    print "Maxim charge in sphere : ", sph_max
    print "------------------------------------------"
##------------------------------------------------------------------
