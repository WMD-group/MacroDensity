...
class TestAveragingFunctions(unittest.TestCase):
    ...
    def test_volume_average(self):
        ...
        potential, variance = md.volume_average([0, 0, 0], [0, 0, 0], [2, 2, 2], test_grid, 5, 5, 5)
        self.assertAlmostEqual(potential, 0.125)
        self.assertAlmostEqual(variance, 0.109375)
        potential, variance = md.volume_average([1, 1, 1], [0, 0, 0], [2, 2, 2], test_grid, 5, 5, 5)
        potential, variance = md.volume_average([1, 1, 1], [0, 0, 0], [3, 3, 3], test_grid, 5, 5, 5)
